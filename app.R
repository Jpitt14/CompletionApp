...
server <- function(input, output, session) {
  ...
  observeEvent(input$submit_team1, {
    new_data <- data.frame(
      ...
      Team = "COWBOYS",
      Box1 = ifelse(selected_conditions$team1[1], "✔", "✖"),
      Box2 = ifelse(selected_conditions$team1[2], "✔", "✖"),
      Box3 = ifelse(selected_conditions$team1[3], "✔", "✖"),
  ...
  observeEvent(input$submit_team2, {
    new_data <- data.frame(
      Order = nrow(results()) + 1,
      Team = "OPPOSITION",
      Box1 = ifelse(selected_conditions$team2[1], "✔", "✖"),
      Box2 = ifelse(selected_conditions$team2[2], "✔", "✖"),
      Box3 = ifelse(selected_conditions$team2[3], "✔", "✖"),
